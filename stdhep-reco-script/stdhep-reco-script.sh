...
#/cern.ch/user/o/oreardon/public/ilc/simulation \

$slic_binary -g /afs/cern.ch/user/o/oreardon/public/ilc/simulation/detectors/sidloi3/sidloi3.lcdd \
-i /afs/cern.ch/user/o/oreardon/public/ilc/pythiaZPoleccbar-0-1000.stdhep \
-o pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3.slcio \
...
input="/afs/cern.ch/user/o/oreardon/public/ilc/simulation/pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3.slcio"
input_no_ext=${input%.*}
...
#Well need to restore the old version so marlin works
old_LD_LIBRARY_PATH=$LD_LIBRARY_PATH
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$ilcsoft_root_dir/slicPandora/v01-00-00/build/lib/

pandora_output="/afs/cern.ch/user/o/oreardon/public/ilc/simulation/pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3_pandora.slcio"
...
#Clean out the crap weve put in $LD_LIBRARY_PATH. Marlin complained about duplicate libraries.
LD_LIBRARY_PATH=$old_LD_LIBRARY_PATH

first_marlin_output="pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3_lcfi.slcio"

echo "Running marlin.."
#$marlin_binary /afs/cern.ch/user/o/oreardon/public/ilc/simulation/BB_sid_dbd_vertexing.xml 
$marlin_binary --global.LCIOInputFiles=$pandora_output --MyLCIOOutputProcessor.LCIOOutputFile=$first_marlin_output /afs/cern.ch/user/o/oreardon/public/ilc/simulation/sid_dbd_vertexing.xml 
if [ "$?" -ne "0" ]; then
  exit 1
fi

lcsim_2_recFile="pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3_full.slcio"
lcsim_2_dstFile="pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3_dst.slcio"

echo "Running second lcsim reco..."
java -jar $lcsim_jar ../myscripts/sid_dbd_postPandora.xml -DinputFile=$first_marlin_output -DrecFile=$lcsim_2_recFile -DdstFile=$lcsim_2_dstFile
...
echo "Running marlin on dst..."
#$marlin_binary --global.LCIOInputFiles=$lcsim_2_dstFile --MyLCIOOutputProcessor.LCIOOutputFile="secondMarlinOutputFromPfos.slcio" /afs/cern.ch/user/o/oreardon/public/ilc/data/stearingFiles/v02_p01/flavortagfrompfo.xml

$marlin_binary --global.LCIOInputFiles=$lcsim_2_dstFile --MyLCIOOutputProcessor.LCIOOutputFile="pythiaZPoleccbar-0-1000_slic-3.1.3_geant4-v9r6p1_QGSP_BERT_sidloi3_dst_flavourtag.slcio" /afs/cern.ch/user/o/oreardon/public/ilc/data/stearingFiles/v02_p01/flavortag.xml
